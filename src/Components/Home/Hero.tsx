    ...
    <>
      ...
      >
        <div className="flex flex-col justify-center max-[600px]:pt-10">
          <h1 className="text-5xl max-[600px]:text-xl text-center font-bold  dark:text-white">
          ...
          <button onClick={()=>Navigate("/login")} className="border border-gray-300 w-fit mx-auto  max-[600px]:text-xs dark:border-gray-700  hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-200 cursor-pointer duration-200 hover:font-bold font-semibold p-2 rounded-lg">
            Try Now, It's Free!
          </button>
          <SubComponent />
        </div>
