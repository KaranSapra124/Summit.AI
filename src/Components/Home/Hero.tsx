    ...
    <>
      ...
      >
        <div className="flex flex-col  justify-center">
          ...
          <p className="my-10 max-w-screen-sm mx-auto text-sm font-bold text-gray-700 dark:text-gray-200 text-center">
  ...
  return (
    <>
      <video
        ...
        loop
        muted
        className="max-w-screen-sm my-4 mx-auto rounded-lg"
